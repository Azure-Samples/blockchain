...
Important: There are new AAD application registration requirements with 1.5. that are not performed by this upgrade process. Please visit https://aka.ms/workbenchAADUpgrade to perform the necessary updated.

```

> Note: The AAD Application Registration configuration has changed for Workbench 1.5. This script does **not** automatically update your Application Registration. Please visit [AAD Upgrade Instructions](https://aka.ms/workbenchAADUpgrade) to update your AAD application.
