...
import net.corda.workbench.basicProvenance.contract.ItemContract.Companion.ITEM_ID
...
@InitiatingFlow
@StartableByRPC
class TransferFlow(private val linearId: UniqueIdentifier,private val newcounterParty: Party) : FlowLogic<SignedTransaction>() {
    ...
    override fun call(): SignedTransaction {
        ...
        val outputstate = _state.transfer(newcounterParty,_state)
        val createCommand = Command(ItemContract.Transfer(), listOf(ourIdentity.owningKey))
